...
async def lifespan(app: FastAPI):
    ...
    load_all_models()
    from app.services import ai_config_service, session_cf_config_service, trip_cost_config_service
    ai_config_service.sync_engine_from_db()
    session_cf_config_service.sync_engine_from_db()
    trip_cost_config_service.sync_transport_cost_into_planner()
