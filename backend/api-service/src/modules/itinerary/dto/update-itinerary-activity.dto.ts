...
export class UpdateItineraryActivityDto {
  ...
  @Matches(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, {
    message: 'arrivalTime phải theo định dạng HH:mm',
  })
  arrivalTime?: string;
  ...
  @IsOptional()
  @Matches(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, {
    message: 'departureTime phải theo định dạng HH:mm',
  })
  departureTime?: string;

  @ApiPropertyOptional({
    example: 120000,
    description: 'Chi phí thực tế (VND)',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: '08:30',
    description: 'Giờ đến bị khóa (HH:mm)',
  })
  @IsOptional()
  @Matches(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, {
    message: 'lockedArriveTime phải theo định dạng HH:mm',
  })
