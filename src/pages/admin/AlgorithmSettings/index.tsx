...
const AlgoGroup: React.FC<{ title: string; children: React.ReactNode }> = ({ title, children }) => (
  <div className="as-group">
    <div className="as-group__header">
      <span className="as-group__title">{title}</span>
    </div>
    <div className="as-group__body">
      {children}
    </div>
  </div>
);
  ...
  return (
    <div className="page-container as-page">
      ...
      <div className="page-content as-content">
        ...
        {/* ━━ Group 1: Tham số thuật toán chung (standalone) ━━━━━━━━━━━━━━━━━━ */}
        <AccordionCard
        ...
        {/* ━━ Group 3: Thuật toán lọc - phân loại đánh giá ━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
