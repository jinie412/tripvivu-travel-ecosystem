...
export class AdminItineraryReviewsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Itinerary review detail retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Itinerary review approved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Itinerary review rejected successfully',
  })
  async rejectReview(
    @Param('id') id: string,
  ...
  @ApiResponse({
    status: 200,
    description: 'Itinerary review status updated successfully',
  })
